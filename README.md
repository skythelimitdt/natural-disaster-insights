...
- Run the App
    - Open 'main.py' (located with the app folder) in your python IDE of choice (such as VSCode) OR...
    - In the terminal, navigate to the app folder within the repo and type `main.py` to run:
```python
python main.py 
```
